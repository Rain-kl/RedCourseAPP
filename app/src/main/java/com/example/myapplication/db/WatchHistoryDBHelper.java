...
public class WatchHistoryDBHelper extends MyDBHelper{
    ...
    public List<WatchHistory> getWatchHistory(int userId) {
        ...
        Cursor cursor = db.query(TABLE_WATCH_HISTORY, new String[] { KEY_HISTORY_ID, KEY_USER_FOREIGN_ID, KEY_CONTENT_ID, KEY_WATCH_DATE,KEY_VIDEO_TITLE,KEY_VIDEO_THUMBNAIL
                // ... 其他字段
